      ...
      <div className="bg-[#6F4E37] rounded-lg p-6 mb-6 text-white">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="text-center">
            ...
            {item.category && (
              <p className="mb-2 italic text-sm">Category: {item.category}</p>
            )}
            ...
            <div className="text-lg font-bold mb-2">
              <span className="text-pink-600">{formatCurrency(item.price)}</span>
              <span className="line-through ml-2 text-white">{formatCurrency(item.price + 30)}</span>
            </div>
